...
namespace Pathology
{
    public partial class Frmopdmaster : Form
    {
        SqlConnection con;
        ...
        private void Frmopdmaster_Load(object sender, EventArgs e)
        {
        ...
        private void RMSAVE_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Save ? ", "", MessageBoxButtons.OKCancel) == DialogResult.OK)
            {
                ...
                if (cboname.Text != "")
                {
                    ...
                    Sqlstr = "select cc,pcode,patient_name,sex,age,doctor,date_exam,due_amount,paid_amount,month_year,Scn,Tpt,cfees,due_amount,paid_amount,expenditure,referal,balance";
                    ...
                    if (ds1.Tables[0].Rows.Count == 0)
                    {
                        ...
                        Sqlstr = "insert into OPD_Master (cc,Patient_name,pcode,sex,age,doctor,date_exam,month_year,Scn,Tpt,cfees,due_amount,paid_amount,expenditure,referal,balance,acdes) values('" + Convert.ToInt32(txtcompanycode.Text) + "','" + this.cboname.Text + "','" + Convert.ToInt32(cbopcode.Text) + "','" + this.cbosex.Text + "','" + Convert.ToInt32(txtage.Text) + "','" + this.cbodoctor.Text + "','" + repdt1 + "','" + cbomy1.Text + "', '" + txtscn.Text + "','" + txttpt.Text + "','" + Convert.ToDouble(txtcf.Text) + "','" + Convert.ToDouble(txtdue.Text) + "','" + Convert.ToDouble(txtpaid.Text) + "','" + Convert.ToDouble(txtexpenditure.Text) + "','" + Convert.ToDouble(txtreferal.Text) + "','" + Convert.ToDouble(txtbalance.Text) + "','" + cboreferal.Text + "')";
                        ...
                        //cmd1 = new SqlCommand("insert into cbj (cc,Trncd,Vodt,Vono,acdes,dcin,Amt,narr,chno,chdt) values('" + Convert.ToInt32(txtcompanycode.Text) + "','Test ','" + repdt1 + "','" + cbopcode.Text + "', '" + cbopcode.Text.Trim() + '-' + cboname.Text + "', 'D', '" + Convert.ToDouble(txtdue.Text) + "', '', '', '')", con);
                    ...
                    else
                    {
                        ...
                        Sqlstr = "update OPD_Master set cc='" + Convert.ToInt32(txtcompanycode.Text) + "',Patient_name='" + this.cboname.Text + "',pcode='" + Convert.ToInt32(cbopcode.Text) + "',sex='" + this.cbosex.Text + "',age='" + Convert.ToInt32(txtage.Text) + "',doctor='" + this.cbodoctor.Text + "',date_exam='" + repdt1 + "',month_year='" + cbomy1.Text + "',Scn='" + txtscn.Text + "',Tpt='" + txttpt.Text + "',cfees='" + Convert.ToDouble(txtcf.Text) + "',due_amount='" + Convert.ToDouble(txtdue.Text) + "',paid_amount='" + Convert.ToDouble(txtpaid.Text) + "',expenditure='" + Convert.ToDouble(txtexpenditure.Text) + "',referal='" + Convert.ToDouble(txtreferal.Text) + "',balance='" + Convert.ToDouble(txtbalance.Text) + "',acdes='" + cboreferal.Text + "' WHERE Pcode='" + Convert.ToInt32(cbopcode.Text) + "'";
                        cmd = new SqlCommand(Sqlstr, con);
                        cmd.ExecuteNonQuery();
                        Sqlstr = "";
                    ...
                    Sqlstr = "select date_exam,pcode,patient_name,scn as mob,due_amount,paid_amount,expenditure,referal,balance,cfees,acdes,doctor";
                        Sqlstr = Sqlstr + " from OPD_Master ";
                        da = new SqlDataAdapter(Sqlstr, con);
                        ds1 = new DataSet();
                        da.Fill(ds1);
        ...
        private void Rmsearch_Click(object sender, EventArgs e)
        {
            ...
            String Sqlstr = "select date_exam,pcode,patient_name,scn as mob,due_amount,paid_amount,expenditure,referal,balance,cfees,acdes,doctor";
       ...
       else
    {
        ...
        private void RMBILLING_Click(object sender, EventArgs e)
        {
            ...
            Frmopdmasterbillentry FPBILLent = new Frmopdmasterbillentry();
            FPBILLent.Show();
        }
        ...
        private void txtexpenditure_Validating(object sender, CancelEventArgs e)
        {
            //Double texp=Convert.ToDouble (txtusg.Text )+Convert.ToDouble (txtendoscopy.Text )+Convert.ToDouble (txtecg.Text )+Convert.ToDouble (txtxray.Text )+Convert.ToDouble (txtctscan.Text )+Convert.ToDouble (txteeg.Text )+Convert.ToDouble (txtextra.Text )+Convert.ToDouble (txtdoppler.Text );
           //txtexpenditure.Text =texp.ToString();
            Double tbal = Convert.ToDouble(txtpaid.Text) - Convert.ToDouble(txtexpenditure.Text) - Convert.ToDouble(txtreferal.Text);
           txtbalance.Text = tbal.ToString();
        }
        ...
        private void txtendoscopy_KeyPress(object sender, KeyPressEventArgs e)
        {
            //callnumber(e);
        }
        ...
        private void txtctscan_KeyPress(object sender, KeyPressEventArgs e)
        {
            //callnumber(e);
        }
        ...
        private void txteeg_KeyPress(object sender, KeyPressEventArgs e)
        {
            //callnumber(e);
        }
        ...
        private void txtdoppler_KeyPress(object sender, KeyPressEventArgs e)
        {
            //callnumber(e);
        }
        ...
        private void txtexpenditure_KeyPress(object sender, KeyPressEventArgs e)
        {
            callnumber(e);
        }

        private void txtreferal_KeyPress(object sender, KeyPressEventArgs e)
        {
            callnumber(e);
        }
        ...
        private void cbopcode_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            RMBILLING.Enabled = true;
            rmdelete.Enabled = true;
            String strsql1 = "select cc,pcode,patient_name,sex,age,doctor,date_exam,month_year,Scn,Tpt,cfees,due_amount,paid_amount,expenditure,referal,balance,acdes";
            ...
            if (ds1.Tables[0].Rows.Count != 0)
            {
                ...
                cboreferal.Text = ds1.Tables[0].Rows[0][16].ToString();
                pat_name = cboname.Text;
               // pidr = Convert.ToInt32 (cbopcode.Text);
            }
        ...
        private void rdprint_Click(object sender, EventArgs e)
        {
            ...
            //fpopd.Show();
            Frmrepopdprescription fpopd = new Frmrepopdprescription();
            fpopd.Show();
        ...
        private void txttpt_TextChanged(object sender, EventArgs e)
        {
        ...
        private void dtreport_ValueChanged(object sender, EventArgs e)
        {
