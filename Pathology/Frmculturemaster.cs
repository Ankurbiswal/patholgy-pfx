...
namespace Pathology
{
    public partial class Frmculturemaster : Form
    {
        SqlConnection con;
        SqlDataAdapter da;
        DataSet ds1;
        ...
        public Frmculturemaster()
        {
            InitializeComponent();
        }

        private void Frmculturemaster_Load(object sender, EventArgs e)
        {
           ...
           new DataGridViewDataErrorEventHandler(dataGridView1_DataError);
            ...
            SqlDataAdapter adapter = new SqlDataAdapter("select test,method,unit,reference_range,price,grp,sgrp,range_from,range_to from CULTURE_master", con);
            DataSet ds = new DataSet();
            adapter.Fill(ds, "CULTURE_master");
        ...
        private void BTNCULSAVE_Click(object sender, EventArgs e)
        {
            ...
            cmd1 = new SqlCommand("delete from CULTURE_master ", con);
        ...
        private void BTNPRINT_Click(object sender, EventArgs e)
        {
            ...
            //SqlDataAdapter adapter = new SqlDataAdapter("select test,method,price,grp,sgrp from CULTURE_master ORDER BY TEST", con);
            //DataSet ds = new DataSet();
