...
namespace Pathology
{
    public partial class Frmculturetype : Form
    {
        SqlConnection con;
        SqlDataAdapter da;
        DataSet ds1;
        ...
        public Frmculturetype()
        {
            InitializeComponent();
        }

        private void Frmculturetype_Load(object sender, EventArgs e)
        {
           ...
           new DataGridViewDataErrorEventHandler(dataGridView1_DataError);
            ...
            SqlDataAdapter adapter = new SqlDataAdapter("select test,method from CULTURE_type", con);

            DataSet ds = new DataSet();
            adapter.Fill(ds, "CULTURE_type");
        ...
        private void BTNCULSAVE_Click(object sender, EventArgs e)
        {
            ...
            cmd1 = new SqlCommand("delete from CULTURE_type ", con);
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                if (dataGridView1.Rows[i].Cells[0].Value != null)
                {
                    ...
                    cmd = new SqlCommand("insert into CULTURE_type(test,method) values ('" + dataGridView1.Rows[i].Cells[0].Value + "','" + dataGridView1.Rows[i].Cells[1].Value + "')", con);
